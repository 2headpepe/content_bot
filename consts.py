...
tg_extra_channel_id = os.getenv("TG_EXTRA_CHANNEL_ID")
folder_login = os.getenv("FOLDER_LOGIN")
folder_password = os.getenv("FOLDER_PASSWORD")
pinterest_non_asian_login = os.getenv("PINTEREST_NON_ASIAN_LOGIN")
pinterest_non_asian_password = os.getenv("PINTEREST_NON_ASIAN_PASSWORD")
tg_hot_channel = os.getenv("TG_HOT_CHANNEL")